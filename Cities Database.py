# Program #2 & #3: Display Cities Data <3
# Date: 12/7/24
# Creates a program that can create cities.db and read the information in it
# Thank you to the text book for this code
import sqlite3

def main():
    # Connect to the database.
    conn = sqlite3.connect('Week 13/cities.db')
